...
const PostJobs = () => {
  ...
  // UseEffect is always executed, regardless of conditions
  useEffect(() => {
    if (isLoaded) {
      fnCompanies();
    }
  ...
  // Handle navigation after job creation
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-0">
        ...
        {loadingCreateJob && <BarLoader className="mb-4" color="#36d7b7" width="100%" />}
